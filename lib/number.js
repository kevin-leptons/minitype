 ...
 *
 * @example
 * _FORMATTER.format(1) // 1
 * _FORMATTER.format(1234) // 1,234
 * _FORMATTER.format(12345678) // 12,345,678
 */
const _FORMATTER = new Intl.NumberFormat(FORMATTER_LOCALE)
/**
 * Transform a number or big number to string, minimum digits is 2.
 *
 * @example
 * _FORMATTER_2.format(1) // 01
 * _FORMATTER_2.format(12) // 12
 * _FORMATTER_2.format(1234) // 1,234
 */
const _FORMATTER_2 = new Intl.NumberFormat(FORMATTER_LOCALE, {
 ...
 *
 * @example
 * _FORMATTER_3.format(1) // 001
 * _FORMATTER_3.format(123) // 123
 * _FORMATTER_3.format(1234) // 1,234
 */
const _FORMATTER_3 = new Intl.NumberFormat(FORMATTER_LOCALE, {
 ...
 *
 * @example
 * _FORMATTER_4.format(1) // 0,001
 * _FORMATTER_4.format(1234) // 1,234
 * _FORMATTER_4.format(12345) // 12,345
 */
const _FORMATTER_4 = new Intl.NumberFormat(FORMATTER_LOCALE, {
 ...
 *
 * @example
 * _FORMATTER_5.format(1) // 00,001
 * _FORMATTER_5.format(12345) // 12,345
 * _FORMATTER_5.format(123456) // 123,456
 */
const _FORMATTER_5 = new Intl.NumberFormat(FORMATTER_LOCALE, {
 ...
 *
 * @example
 * _FORMATTER_6.format(1) // 000,001
 * _FORMATTER_6.format(123456) // 123,456
 * _FORMATTER_6.format(1234567) // 1,234,567
 */
const _FORMATTER_6 = new Intl.NumberFormat(FORMATTER_LOCALE, {
 ...
 *
 * @example
 * _FORMATTER_7.format(1) // 0,000,001
 * _FORMATTER_7.format(1234567) // 1,234,567
 * _FORMATTER_7.format(12345678) // 12,345,678
 */
const _FORMATTER_7 = new Intl.NumberFormat(FORMATTER_LOCALE, {
 ...
 *
 * @example
 * _FORMATTER_8.format(1) // 00,000,001
 * _FORMATTER_8.format(12345678) // 12,345,678
 * _FORMATTER_8.format(123456789) // 123,456,789
 */
const _FORMATTER_8 = new Intl.NumberFormat(FORMATTER_LOCALE, {
 ...
 *
 * @example
 * _FORMATTER_8.format(1) // 000,000,001
 * _FORMATTER_8.format(123456789) // 123,456,789
 * _FORMATTER_8.format(1234567891) // 1,234,567,891
 */
const _FORMATTER_9 = new Intl.NumberFormat(FORMATTER_LOCALE, {
...
class UInt {
    ...
    /**
     * See {@link _FORMATTER} for more details.
     *
     * @return {string}
     */
    format() {
        return _FORMATTER.format(this._value)
    }

    /**
     * See {@link _FORMATTER_2} for more details.
     *
     * @return {string}
     */
    format2() {
        return _FORMATTER_2.format(this._value)
    }

    /**
     * See {@link _FORMATTER_3} for more details.
     *
     * @return {string}
     */
    format3() {
        return _FORMATTER_3.format(this._value)
    }

    /**
     * See {@link _FORMATTER_4} for more details.
     *
     * @return {string}
     */
    format4() {
        return _FORMATTER_4.format(this._value)
    }

    /**
     * See {@link _FORMATTER_5} for more details.
     *
     * @return {string}
     */
    format5() {
        return _FORMATTER_5.format(this._value)
    }

    /**
     * See {@link _FORMATTER_6} for more details.
     *
     * @return {string}
     */
    format6() {
        return _FORMATTER_6.format(this._value)
    }

    /**
     * See {@link _FORMATTER_7} for more details.
     *
     * @return {string}
     */
    format7() {
        return _FORMATTER_7.format(this._value)
    }

    /**
     * See {@link _FORMATTER_8} for more details.
     *
     * @return {string}
     */
    format8() {
        return _FORMATTER_8.format(this._value)
    }

    /**
     * See {@link _FORMATTER_9} for more details.
     *
     * @return {string}
     */
    format9() {
        return _FORMATTER_9.format(this._value)
    }
...
class UInt8 {
    ...
    static fromDecimal(value) {
        ...
        let {data: decimal} = r1
        if (_isDecimalGreater(decimal, '255')) {
...
class UInt16 {
    ...
    static fromDecimal(value) {
        ...
        let {data: decimal} = r1
        if (_isDecimalGreater(decimal, '65535')) {
...
class UInt32 {
    ...
    static fromDecimal(value) {
        ...
        let {data: decimal} = r1
        if (_isDecimalGreater(decimal, '4294967295')) {
...
class UInt64 {
    ...
    static fromDecimal(value) {
        ...
        let {data: decimal} = r1
        if (_isDecimalGreater(decimal, '18446744073709551615')) {
...
class PInt {
    ...
    static fromDecimal(value) {
        ...
        if (_isDecimalGreater(decimal, '9007199254740991')) {
...
class PInt256 {
    ...
    static fromDecimal(value) {
        ...
        let {data: decimal} = r1
        if (_isDecimalGreater(decimal, PInt256._MAX_DECIMAL)) {
            return Result.typeError(
     ...
     */
    eq(other) {
        validateInstance(other, PInt256).open()
        return (this._value === other._value)
    }
...
class UInt256 {
    ...
    static fromDecimal(value) {
        ...
        let {data: decimal} = r1
        if (_isDecimalGreater(decimal, UInt256._MAX_DECIMAL)) {
            return Result.typeError(
 ...
 * @example
 * _isDecimalGreater('2', '1') // => true
 * _isDecimalGreater('2', '2') // => false
 * _isDecimalGreater('2', '3') // => false
 * _isDecimalGreater('91', '900') // => false
 */
function _isDecimalGreater(operand1, operand2) {
